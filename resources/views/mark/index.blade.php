						...
						<div class="flex flex-col md:flex-row space-x-2 gap-4">
							...
							<div class="mb-4 inline-flex flex-col sm:flex-row sm:items-center gap-2">
								...
								<div class="flex items-center gap-2">
									<a href="{{ route('marks.export.csv', $exportQuery) }}" class="inline-flex items-center px-3 py-2 bg-gray-100 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200 transition whitespace-nowrap">
										{{ __('CSV') }}
									</a>
								</div>
							</div>
