                    ...
                    <div class="max-w-xl mx-auto">
                        <form action="{{ route('assessments.store') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0.01" max="999.99" name="max_score" id="max_score" value="{{ old('max_score') }}" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500" required>
                                @error('max_score')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.01" min="0" max="100" name="weight" id="weight" value="{{ old('weight') }}" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:ring-blue-500" required>
                                @error('weight')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="flex items-center justify-end gap-4">
                                ...
                                <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 transition">{{ __('Create Assessment') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
