                ...
                <div class="max-w-xl mx-auto">
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-gray-600">Update the user details below.</p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <fieldset class="border-2 p-2 rounded-md">
                                ...
                                <label class="inline-flex items-center">
                                    <input type="checkbox" value="{{ $role->name }}" name="roles[]" class="form-checkbox h-5 w-5 text-blue-600" {{ in_array($role->name, $selectedRoles, true) ? 'checked' : '' }}>
