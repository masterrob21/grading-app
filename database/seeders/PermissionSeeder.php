...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'create users', 'guard_name' => 'web', 'module' => 'user']);
        ...
        Permission::create(['name' => 'create roles', 'guard_name' => 'web', 'module' => 'role']);
        ...
        Permission::create(['name' => 'create departments', 'guard_name' => 'web', 'module' => 'department']);
        ...
        Permission::create(['name' => 'create students', 'guard_name' => 'web', 'module' => 'student']);
        ...
        Permission::create(['name' => 'create academic years', 'guard_name' => 'web', 'module' => 'academic_year']);
        ...
        Permission::create(['name' => 'create courses', 'guard_name' => 'web', 'module' => 'course']);
        ...
        Permission::create(['name' => 'create course users', 'guard_name' => 'web', 'module' => 'course_user']);
        ...
        Permission::create(['name' => 'create marks', 'guard_name' => 'web', 'module' => 'mark']);
        ...
        Permission::create(['name' => 'create assessments', 'guard_name' => 'web', 'module' => 'assessment']);
        ...
        Permission::create(['name' => 'create enrollments', 'guard_name' => 'web', 'module' => 'enrollment']);
